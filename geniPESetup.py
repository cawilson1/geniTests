...
os.system("iptables -A INPUT -i eth1 -s 10.10.1.2 -j ACCEPT")
os.system("iptables -A INPUT -i eth1 -s 10.10.1.1 -j ACCEPT")
os.system("iptables -A INPUT -i eth1 -s 10.10.2.1 -j ACCEPT")
os.system("iptables -A INPUT -i eth1 -s 10.10.2.2 -j ACCEPT")
